    ...
    <Section row nopadding>
      <LeftSection>
        ...
        <SectionText style={{ paddingBottom: '15px', zIndex: 10 }} bolder>
          I am an inquisitive, energetic 3rd year Computing student skilled in software design and development, with a
          strong foundation in maths, logic, and coding.
        </SectionText>
        <SectionText bolder>
          Seeking to leverage solid skills, collaboration and development as a software engineer.
        </SectionText>
        <div style={{ paddingTop: '55px' }}>
          <Button style={{}} onClick={() => (window.location = linkToCV)}>
            My CV
          </Button>
        </div>
      </LeftSection>
