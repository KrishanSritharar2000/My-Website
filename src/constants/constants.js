...
export const acomplishments = [
  ...
  { number: '90,000 words', text: '250 page, A Level Coursework' },
...
export const projects = [
  ...
  },
  {
    ...
    time: '3',
    teamSize: '4',
    code: 'https://github.com/KrishanSritharar2000/',
    live: 'https://github.com/KrishanSritharar2000/',
  },
  {
    id: 3,
    title: 'PintOS',
  ...
  },
  {
    ...
    commits: 58,
    branches: 1,
    image: '/images/cflow.png',
    languages: ['C', 'Makefile'],
    time: '',
    teamSize: '',
    code: 'https://github.com/KrishanSritharar2000/CFlow',
    live: 'https://github.com/KrishanSritharar2000/CFlow',
  },
  {
    id: 5,
    title: 'Royal Chat',
  ...
  },
  {
    ...
    commits: 50,
    branches: 1,
    image: '/images/modellingQuantumGravity.png',
    languages: ['Python', 'Processing'],
    time: '',
    teamSize: '',
    code: 'https://github.com/KrishanSritharar2000/Modelling-Quantum-Gravity',
    live: 'https://github.com/KrishanSritharar2000/Modelling-Quantum-Gravity',
  },
  {
    id: 7,
    ...
    commits: 40,
    branches: 1,
    image: '/images/mentalMathsGame.png',
    languages: ['Python'],
    time: '',
    teamSize: '',
    code: 'https://github.com/KrishanSritharar2000/Mental-Maths-Game',
    live: 'https://github.com/KrishanSritharar2000/Mental-Maths-Game',
  },
];
